...
Guidewire DEVTrails 2026 Phase 1 · Seed Swiggy / Zomato Income Loss Only
...
📎 Quick Links
Resource	Access
📄 Full Idea Blueprint	View Document
📊 Pitch Deck (PPT)	View Presentation
🎥 Detailed - Strategy Video	Watch Video
🗂️ GitHub Repository	Open Repository (main branch)
...
Trigger = dynamic percentage based on deviation from the zone's own historical baseline. It's not a binary "yes/no" — the payout scales proportionally to how severely the local normal is disrupted.
...
Ravi, 28 | Swiggy Partner | Bengaluru Lost 6 days of income last monsoon. Zero compensation. Had no choice but to ride in dangerous conditions because stopping meant no money. Uses WhatsApp daily, will not install a new app, earns ₹800/day and lives week to week.
...
The same geo-adaptive, agentic model extends to: E-commerce (Amazon/Flipkart) → Q-Commerce (Zepto/Blinkit) → Cab drivers (Uber/Ola) → Logistics gig workers

One engine. Every gig worker in India.

✅ Phase 1 Checklist
 Unique geo-adaptive positioning defined
 Persona scenario + end-to-end workflow
 Dynamic AI weekly premium model integrated
 L0–L4 proportional trigger system with zone-relative thresholds
 Income estimation model
 Multi-trigger fusion & Agentic AI logic
 AI model breakdown (pricing · fraud · orchestration)
 Edge case handling
 Fraud detection strategy
 Tech stack + platform justified
...
Repository	CholaGanesh05/Guidewire_Devtrails_200-Syndicate
Not just insurance. An autonomous, adaptive income protection engine that understands where you live, how you work, and when the world truly gets in your way.
